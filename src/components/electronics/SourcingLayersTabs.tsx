...
const sections = [
  ...
  {
    id: "tradeshows",
    label: "Trade Shows for Electronics",
    icon: (
  ...
  {
    id: "markets",
    label: "Electronics Markets & Factory Districts",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst Verified Electronics Suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-electronics" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Source <span className="accent-word">Electronics</span> from China
        </h2>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      1688 is Alibaba&apos;s domestic B2B marketplace — where Chinese factories
                      trade with each other. For electronics, that means component pricing,
                      factory-direct MOQs, and access to the upstream supply chain that
                      Alibaba.com doesn&apos;t show you.
                    </p>
