...
const featuredSuppliers = [
  ...
  { companyName: "Dongsheng Audio Equipment", specialty: "Professional audio, amplifiers, studio monitors", since: "2013", initials: "DS", gradientFrom: "#A855F7", gradientTo: "#7C3AED" },
  ...
  return (
    <div>
      <p className="text-sm text-wf-text-secondary mb-5 max-w-2xl">
        ...
        and maintain consistent trading performance in electronics manufacturing.
      </p>
