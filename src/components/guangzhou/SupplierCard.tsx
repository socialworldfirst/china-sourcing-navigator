...
export default function SupplierCard({ companyName, specialty, since, initials, gradientFrom, gradientTo }: SupplierCardProps) {
  return (
    <div className="relative bg-white border border-wf-border rounded-2xl overflow-hidden">
      {/* Gradient header — no overlay/gradient covering content */}
      <div
      ...
      {/* Content — fully visible, no gradient overlay */}
      <div className="p-5">
